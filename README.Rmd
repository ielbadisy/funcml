...
whether each engine is currently available. You can also filter the catalog by
task or capability and request only the columns you need for reporting or
