...
shows which engines are registered, what each learner supports, and which
...
`list_learners()` is the current catalog API. It returns one row per learner id
with support flags, interpretation capabilities, engine package names, and
